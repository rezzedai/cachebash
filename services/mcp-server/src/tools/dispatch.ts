  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        completed_status: { type: "string", enum: ["SUCCESS", "FAILED", "SKIPPED", "CANCELLED", "PARTIAL"], default: "SUCCESS", description: "Completion outcome. PARTIAL = meaningful work shipped but the task's full scope did not; requires successorTaskId." },
        successorTaskId: { type: "string", description: "Required when completed_status is PARTIAL: the task id where the remaining scope continues. Not validated for existence — the layer only checks it is present." },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        completed_status: { type: "string", enum: ["SUCCESS", "FAILED", "SKIPPED", "CANCELLED", "PARTIAL"], default: "SUCCESS", description: "Completion outcome (applied to all). PARTIAL requires successorTaskId." },
        successorTaskId: { type: "string", description: "Required when completed_status is PARTIAL (applied to all): the task id where the remaining scope continues." },
