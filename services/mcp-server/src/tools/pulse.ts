  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        contextBytes: { type: "number", minimum: 0, maximum: 100, description: "Context window remaining as a percentage (0–100). Legacy field name — prefer contextUsedPct for new callers. When provided, automatically appends time-series entry to session contextHistory." },
        contextUsedPct: { type: "number", minimum: 0, maximum: 100, description: "Context window used as a percentage (0–100, higher = fuller). Canonical field. When provided, automatically appends time-series entry to session contextHistory." },
